...
def eval_model(image_path, query, predictions_file,tokenizer, model, image_processor, context_len, all_preds):
    ...
    images_tensor=images_tensor[0].unsqueeze(0).to(model.device, dtype=torch.float16)
    ...
    with torch.inference_mode():
        model = model.to(torch.float32) #added
...
if __name__ == "__main__":
    ...
    #image_directory="/Users/marcosalme/Desktop/ReportGenerationFT/IU_xray/images/images_normalized/"
    image_directory="/mimer/NOBACKUP/groups/naiss2023-6-336/msalme/bioRAG/small_mimic_kaggle/"
    predictions_file="llava-rad.txt"
    json_predictions_file="llava-rad.json"
    model_path='./checkpoints/llava-Vicuna-v1-7b-finetune_loraMimic_spliceTerms2'
    #model_path='./checkpoints/llava-Vicuna-7b-pretrainMimic'
    test_json='./data/mimic_valKaggle_ragKeywords.json'
    #model_base='/Users/marcosalme/Desktop/ReportGenerationFT/Vicuna-7b-v1.3'
