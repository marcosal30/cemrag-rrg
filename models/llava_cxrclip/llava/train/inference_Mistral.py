...
def eval_model(image_path, query, predictions_file,tokenizer, model, image_processor, context_len, all_preds,i):
    ...
    with torch.inference_mode():
        model = model.to(torch.bfloat16) #added
...
if __name__ == "__main__":
    ...
    image_directory="/mimer/NOBACKUP/groups/naiss2023-6-336/msalme/ReportGenerationData/IU_xray/images/images_normalized/"

    #predictions_file="predictionsTestMistralFTMimicTot_prompt2.txt"
    #json_predictions_file="predictionsTestMistralFTMimicTot_prompt2.json"
    predictions_file="predictionsIU_xrayFT_prompt2.txt"
    json_predictions_file="predictionsIU_xrayFT_prompt2.json"
    model_path='./checkpoints/llava-Mistral-7b-finetune_loraMimicTot_prompt2'
    #test_json='./data/mimic-cxr_test_prompt2.json'
    test_json='./data/iuxrayFrontal_prompt2.json'
    model_base="/mimer/NOBACKUP/groups/snic2022-5-277/msalme/ReportGenerationFT/Mistral-7B-Instruct-v0.3"
