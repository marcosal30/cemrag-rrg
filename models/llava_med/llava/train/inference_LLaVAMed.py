...
if __name__ == "__main__":
    ...
    #predictions_file="predictionsTestLLaVAMedFTMimicTot_prompt2.txt"
    #json_predictions_file = "predictionsTestLLaVAMedFTMimicTot_prompt2.json"
    predictions_file="predictionsLLaVAMedFTIU_xray_prompt2.txt"
    json_predictions_file="predictionsLLaVAMedFTIU_xray_prompt2.json"
    model_path="/mimer/NOBACKUP/groups/naiss2023-6-336/msalme/bioRAG/LLaVAMed/checkpoints/llava-med-finetune_loraMimicTot_prompt2"
