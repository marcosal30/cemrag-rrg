...
cd /mimer/NOBACKUP/groups/naiss2023-6-336/msalme/bioRAG/LLaVAMed/llava-med_venv || exit

source bin/activate

#Executes the code

cd /mimer/NOBACKUP/groups/naiss2023-6-336/msalme/bioRAG/LLaVAMed|| exit

export WANDB_MODE=offline

python llava/train/inference_LLaVAMed_baseline.py 
