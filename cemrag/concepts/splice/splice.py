...
def load(name: str, vocabulary: str, vocabulary_size: int = -1, device = "cuda" if torch.cuda.is_available() else "cpu", download_root = None, **kwargs):
        ...
        if model_name in SUPPORTED_MODELS[library]:
            if library == "clip":
                ...
                if model_name=="BiomedCLIP":
                    clip_backbone = open_clip.create_model('hf-hub:microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224', device=device)
    ...
    if vocabulary in SUPPORTED_VOCAB:
        ...
        vocab_path="/Users/marcosalme/Desktop/bioRAG/SPLICE_code/data/vocab/"+vocabulary+".txt"
        #concept_root = download_root or os.path.expanduser("~/.cache/splice/")
        concept_root = "/Users/marcosalme/Desktop/bioRAG/SPLICE_code/data/"
    ...
    mean_path ="/Users/marcosalme/Desktop/bioRAG/SPLICE_code/data/"+"means/"+ f"{library}_{model_path}_image.pt"
...
def get_vocabulary(name: str, vocabulary_size: int, download_root = None):
    ...
    if name in SUPPORTED_VOCAB:
        ...
        vocab_path="/Users/marcosalme/Desktop/bioRAG/SPLICE_code/data/vocab/"+name+".txt"
        vocab = []
        with open(vocab_path, "r") as f:
            lines = f.readlines()
            if vocabulary_size > 0:
